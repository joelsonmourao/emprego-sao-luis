        ...
        <div className="flex flex-col justify-center space-y-6">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-[1.75rem] border border-slate-200 bg-white/90 p-5">
              ...
              <p className="mt-2 text-sm leading-6 text-slate-600">Crie, edite, publique e remova vagas e posts sem sair do painel.</p>
            </div>
            <div className="rounded-[1.75rem] border border-slate-200 bg-white/90 p-5">
              <p className="text-sm font-semibold text-slate-950">Importacao em lote</p>
              <p className="mt-2 text-sm leading-6 text-slate-600">Envie planilhas, revise os dados e traga varias vagas de uma vez com mais seguranca.</p>
            </div>
            <div className="rounded-[1.75rem] border border-slate-200 bg-white/90 p-5">
              <p className="text-sm font-semibold text-slate-950">Rotas seguras</p>
              <p className="mt-2 text-sm leading-6 text-slate-600">Acesso restrito para quem esta logado, com a area administrativa separada do site publico.</p>
            </div>
          </div>
        </div>
