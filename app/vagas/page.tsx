...
export default async function JobsPage({
  ...
  return (
    <section className="mx-auto max-w-7xl space-y-8 px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
      ...
      <div className="brand-page-hero rounded-[2rem] border border-slate-200 px-5 py-6 shadow-[0_35px_120px_-70px_rgba(26,43,76,0.22)] sm:rounded-[2.2rem] sm:px-8 sm:py-8">
        <div className="space-y-4">
          ...
          <h1 className="text-[2rem] font-black tracking-tight leading-[1.08] text-[var(--brand-navy)] sm:text-5xl">{heading}</h1>
          <p className="max-w-4xl text-[15px] leading-7 text-[var(--brand-text-secondary)] sm:text-lg sm:leading-8">{intro}</p>
          <div className="no-scrollbar flex items-center gap-3 overflow-x-auto pb-1 text-sm">
            ...
            <Link
              ...
              className={
                parsed.order === "relevance"
                  ? "whitespace-nowrap rounded-full bg-[var(--brand-navy)] px-4 py-2 font-semibold text-white"
                  : "whitespace-nowrap rounded-full border border-[color:rgba(26,43,76,0.1)] bg-white px-4 py-2 font-medium text-[var(--brand-text-secondary)] transition hover:border-[color:rgba(255,109,0,0.22)] hover:text-[var(--brand-orange)]"
              }
            >
              Relevancia
            </Link>
      ...
      <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
        <div className="brand-chip rounded-[1.8rem] p-5 sm:rounded-[2rem] sm:p-6">
        ...
        <div className="brand-panel rounded-[1.8rem] border border-slate-200 p-6 shadow-[0_25px_80px_-50px_rgba(26,43,76,0.22)] sm:rounded-[2rem] sm:p-8">
          <SectionHeading
