...
const permissionKeys = ["jobs.read", "jobs.create", "jobs.review", "jobs.publish", "imports.manage", "companies.manage", "content.manage", "media.manage", "media.upload", "media.delete", "media.restore", "social.manage", "audience.manage", "commercial.manage", "payments.manage", "payments.approve", "seo.manage", "users.manage", "settings.manage", "settings.brand.view", "settings.brand.manage", "audit.read", "queues.manage", "ads.manage"];
