...
import { setAdsenseReviewMode } from "../../../lib/adsense-review-mode";
...
export const POST: APIRoute = async ({ request, locals }) => {
  ...
  if (!auth || !can(auth, "seo.manage")) return adminJsonError("Sem permissão para alterar o Modo de Revisão AdSense.", 403);
  ...
  return adminJsonRedirect("/admin/adsense-readiness#configuracoes", {
    message: result.before === result.after
